...
?>
	...
	$("#button-payment-method").click(function(){
		...
		else
		{
			...
			$.ajax({
				type: 'POST',
				url: '<?=$http_prefix?>://<?=$_SERVER['HTTP_HOST']?><?=$_SERVER['PHP_SELF']?>/index.php?route=extension/payment/ecpayinvoice/set_invoice_info',
				dataType: 'html',
...
<script type="text/javascript">
	...
	$( document ).ready(function() {
		...
		$.ajax({
			type: 'POST',
			url: '<?=$http_prefix?>://<?=$_SERVER['HTTP_HOST']?><?=$_SERVER['PHP_SELF']?>/index.php?route=extension/payment/ecpayinvoice/del_invoice_info',
			dataType: 'html',
